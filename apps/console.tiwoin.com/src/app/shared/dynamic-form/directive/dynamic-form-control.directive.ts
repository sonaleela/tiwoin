import { ComponentRef, Directive, forwardRef, Input, OnDestroy, ViewContainerRef } from '@angular/core';
...
export class DynamicFormControlDirective implements ControlValueAccessor, OnDestroy {
  ...
  createControlComponent(field: any) {
    ...
    const subscirpiton = this.controlComponentRef.instance.valueChange.subscribe((val: any) => this.changeFunction(val));
